                ...
                <div class="ways-contact">
                    ...
                    <ul class="list-icons">
                        <li>
                            ...
                            <a href="mailto:henriqueteixeira26@gmail.com"><p>henriqueteixeira26@gmail.com</p></a>
                        </li>
                        <li>
                            <i class="fa fa-location-dot" id="icon-contact"></i>
                            <p class="mg-icon-2">Governador Valadares, Minas Gerais - Brasil</p>
                        </li>
                    </ul>
                </div>
                <form action="https://formsubmit.co/fecfce57d3e403900dad1688f2d9c317" method="POST" class="form-contact">
                    <input type="hidden" name="_next" value="https://Henrique990.github.io/portifolio/" />
